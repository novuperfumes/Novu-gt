...
export function Disenador() {
  ...
  const { banners: dynamicBanners } = useBanners('disenador');
  ...
  const defaultSlides = [
    {
      bgImage: "/imagenes/banner_disenador1.jpg",
      tag: "DISEÑADOR DESTACADO",
      title: "BLEU DE CHANEL",
      desc: "El elogio de la libertad masculina en una fragancia amaderada aromática con una estela cautivadora.",
      link: "#novedades-section",
      btnText: "EXPLORAR FRAGANCIA"
    },
    {
      bgImage: "/imagenes/banner_disenador2.jpg",
      tag: "NUEVO ELIXIR",
      title: "DIOR SAUVAGE",
      desc: "Una concentración excepcional que mezcla la frescura icónica con un corazón de especias embriagador.",
      link: "#grid-section",
      btnText: "VER MÁS DETALLES"
    }
  ];
    ...
    <>
      ...
      <main className="arabe-main">
        ...
        <section className="products-grid-section" id="grid-section">
          <div className="section-container">
            <h2 className="grid-section-title">COLECCIÓN DE PERFUMES DE DISEÑADOR</h2>
